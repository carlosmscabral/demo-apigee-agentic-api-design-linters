...
```bash
# Deploy the Agentic Spec (Success)
./deploy.sh

# Attempt to Deploy the Legacy Spec (Failure)
./deploy.sh legacy
```

This hands-on exercise demonstrates how **governance-as-code** can prevent "hallucination-prone" APIs from ever reaching production.
